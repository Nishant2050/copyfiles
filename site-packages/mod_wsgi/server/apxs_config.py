...
if WITH_HTTPD_PACKAGE:
    ...
    BINDIR = '/tmp/pip-build-env-n16ldo9b/overlay/lib64/python3.7/site-packages/mod_wsgi_packages/httpd/bin'
    SBINDIR = '/tmp/pip-build-env-n16ldo9b/overlay/lib64/python3.7/site-packages/mod_wsgi_packages/httpd/bin'
    LIBEXECDIR = '/tmp/pip-build-env-n16ldo9b/overlay/lib64/python3.7/site-packages/mod_wsgi_packages/httpd/modules'
    SHLIBPATH = ''
